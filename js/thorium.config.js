...
*/
const kAppBuild= "Build #9";
const kDebugMessagesLevel= 0;
const kHybridAppsLog = true;
const kAutoUpdate=true;
const kShowPreloader=true;
const kLocalRoot = "http://localhost:8080/qr_read/";
...
const kSkipButtonText="Install the PWA";
const kAddToHomeScreenTitle="QRimage decode";
const kAddToHomeScreenMdText="installing this will allow this app to be a PWA on your Android Device";
const kAddToHomeScreenIosText="Installing will allow you to access this app more seemlessly and securely from your home screen";
const kImgMaxSize=10;
const kDocMaxSize=10;
const kMultilingual=true;
